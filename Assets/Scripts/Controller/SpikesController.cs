...
public class SpikesController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        defaultPosition =
            new Vector3(Camera.main.ViewportToWorldPoint(new Vector2(1, 1)).x - additionalValueForSpikesPosition,
                defaultPosition.y, 0);
    }
    ...
    public void SetSpikes()
    {
        ...
        Vector3 previousPosition =
            new Vector3(defaultPosition.x * GameController.Instance.Bird.direction, defaultPosition.y, 0);
        int position;
        ...
        for (int i = 0; i < spikeAmount; i++)
        {
            ...
            spike.transform.eulerAngles = tempRotation;
